...
.event_manager_event_actions {
	background: url(<?php echo $graphics_folder; ?>rsvp.png) right center no-repeat;
	padding-right: 35px;
	cursor: pointer;
	font-size: 10pt;
	font-weight: bold;
...
.event_manager_tool_actions_drop_down {	
    background: #FFFFFF;
    padding: 5px 2px 5px 0;
    position: absolute;
    white-space: nowrap;
...
.event_manager_tool_actions_drop_down li {
	padding: 0 18px 0 10px;
	line-height: 18px;	
}
/* Add(Copy) End */
