...
/* Add Tani 2013.07.20 */
elgg_register_menu_item('page', array('name' => 'A01_group_contest',
                                      'text' => elgg_echo('groups:contest'),
//                                      'href' => elgg_get_site_url() . 'groups/contest',
                                      'href' => $base . 'contest',
                                      'section' => 'A'));
...
} else if (($page != 'owner') && ($page != 'friends')) {
