...
.elgg-page-default .elgg-page-body {
	background: url(<?php echo elgg_get_site_url(); ?>_graphics/bg/asterisk1.jpg) repeat 0 0; 
}
/* Add End */
...
.elgg-page-topbar {
/*	background: #3B5998; */
	background: white url(<?php echo elgg_get_site_url(); ?>_graphics/headbg_large.jpg) no-repeat 200px 0px; 
/*	position: fixed; */
	height: 105px;
	left: 0;
	right: 0;
...
.slides { position:relative; width:510px; height:100px;}
