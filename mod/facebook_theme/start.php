...
function facebook_theme_pagesetup_handler() {
	...
	if (elgg_is_logged_in()) {
		...
		if (elgg_is_active_plugin('event_manager')) {
			elgg_register_menu_item('page', array(
				'name' => 'events',
				'text' => elgg_view_icon('star') . elgg_echo("item:object:event"),
				'href' => "/events",
				'contexts' => array('dashboard'),
			));
		}
		...
		if (elgg_is_active_plugin('tidypics')) {
			elgg_register_menu_item('page', array(
				//'section' => 'more',	
				'name' => 'gallery',
				'text' => elgg_view_icon('star') . elgg_echo("photos"),
				'href' => "/photos/all",
				'contexts' => array('dashboard'),
			));
		}
		...
		/* Add Tani 2013.07.16 */
		//group->interests = contest -> guid
		if (elgg_is_active_plugin('groups')) {
			elgg_register_menu_item('page', array(
				'name' => 'contest',
				'text' => elgg_view_icon('contest') . elgg_echo('groups:contest'),
				'href' => "/photos/group/174",
				'contexts' => array('dashboard'),
			));
		}
		/* Add End */
...
*/
		...
		if (elgg_is_active_plugin('thewire')) {
			elgg_register_menu_item('page', array(
				'section' => 'more',
				'name' => 'thewire',
				'text' => elgg_view_icon('speech-bubble') . elgg_echo('thewire'),
		...
		elgg_unregister_menu_item('footer', 'rss');
		elgg_register_menu_item('extras', array(
			'name' => 'rss',
		...
		if (elgg_is_active_plugin('contact')) {
			elgg_register_menu_item('extras', array(
				'name' => 'contactus',
				'text' => elgg_view_icon('rss') . elgg_echo('contact:us'),
				'href' => '/contact/',
			));
		}
		...
		/* Add Tani */
		if (elgg_is_active_plugin('info_pages')) {
			if (elgg_is_admin_logged_in()) {
				elgg_register_menu_item('topbar', array(
					'href' => '/info_pages',
					'name' => 'info_pages',
